...
// TODO: I see where the name comes from (from scanf), but usually when we
//       take some text from console or file, the more appropriate word is "read"
double scan_coef (char name);

// TODO: "Answer" is too generic, specific word like "solution" would be better, rename.
int print_answers (nRoots, double x1, double x2);


// TODO: Why is it clearBuf? Rename
void clearBuff (void);
